...
public:
    ...
    virtual bool fillBranches(const pat::Jet &, const pat::Jet &, const size_t& unsubJetidx, const size_t& jetidx, const  edm::View<pat::Jet> * unsubColl=0, const  edm::View<pat::Jet> * coll=0)=0;
