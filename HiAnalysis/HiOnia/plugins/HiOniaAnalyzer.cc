...
HiOniaAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  if(Reco_QQ_size==0){
    /*
    std::fill_n(Reco_mu_trig, Reco_mu_size, 0);
    std::fill_n(Reco_mu_TrkMuArb, Reco_mu_size, 0);
    std::fill_n(Reco_mu_TMOneStaTight, Reco_mu_size, 0);
    std::fill_n(Reco_mu_nPixValHits, Reco_mu_size, 0);
    std::fill_n(Reco_mu_nMuValHits, Reco_mu_size, 0);
    std::fill_n(Reco_mu_nTrkHits, Reco_mu_size, 0);
    std::fill_n(Reco_mu_normChi2_inner, Reco_mu_size, 0);
    std::fill_n(Reco_mu_normChi2_global, Reco_mu_size, 0);
    std::fill_n(Reco_mu_nPixWMea, Reco_mu_size, 0);
    std::fill_n(Reco_mu_nTrkWMea, Reco_mu_size, 0);
    std::fill_n(Reco_mu_StationsMatched, Reco_mu_size, 0);
    std::fill_n(Reco_mu_dxy, Reco_mu_size, 0);
    std::fill_n(Reco_mu_dxyErr, Reco_mu_size, 0);
    std::fill_n(Reco_mu_dz, Reco_mu_size, 0);
    std::fill_n(Reco_mu_dzErr, Reco_mu_size, 0);
    std::fill_n(Reco_mu_pt_inner, Reco_mu_size, 0);
    std::fill_n(Reco_mu_pt_global, Reco_mu_size, 0);
    std::fill_n(Reco_mu_ptErr_inner, Reco_mu_size, 0);
    std::fill_n(Reco_mu_ptErr_global, Reco_mu_size, 0);
    std::fill_n(Reco_mu_highPurity, Reco_mu_size, 0);
    std::fill_n(Reco_mu_charge, Reco_mu_size, 0);
    std::fill_n(Reco_mu_type, Reco_mu_size, 0);
    std::fill_n(Reco_mu_whichGen, Reco_mu_size, 0);
    std::fill_n(Reco_mu_SelectionType, Reco_mu_size, 0);
    std::fill_n(Reco_mu_charge, Reco_mu_size, 0);
    */
    Reco_mu_4mom->Clear();
    Reco_mu_size =0;
