...
options.outputFile = 'Oniatree_UpsilonMassRegion_PbPb2024_HIPhysicsRawPrime.root'
...
process.onia2MuMuPatGlbGlb.dimuonSelection       = cms.string("mass > 6.0 && mass < 14.0 && abs(daughter('muon1').innerTrack.dz - daughter('muon2').innerTrack.dz) < 25")
process.onia2MuMuPatGlbGlb.lowerPuritySelection  = cms.string("pt > 2.5 && abs(eta) < 2.4 && isTrackerMuon")
...
if applyEventSel:
  ...
  # Muon filtering
  SuperLooseMuonCut = "isTrackerMuon && pt > 2.5 && abs(eta) < 2.4"
  ...
  process.dimuonSelection = cms.EDProducer("CandViewShallowCloneCombiner",
                                    ...
                                    cut = cms.string("mass > 6.0 && mass < 14.0"),
