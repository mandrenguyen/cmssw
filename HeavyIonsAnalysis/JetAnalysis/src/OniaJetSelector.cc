...
public:
  ...
  OniaJetSelector(edm::ParameterSet const &params)
...
// > >  PFJetXSelectorPtr;
typedef OniaJetSelector<pat::Jet, std::vector<edm::FwdPtr<pat::PackedCandidate>>>
    OniaPatJetSelector;

DEFINE_FWK_MODULE(OniaPatJetSelector);
