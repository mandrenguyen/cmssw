...
using namespace pat;
// MuonUnpacker is also provided by HeavyIonsAnalysis/MuonAnalysis.  The two
// implementations are identical; use that registration when both packages
// are present in a combined HiForest/Onia release.
