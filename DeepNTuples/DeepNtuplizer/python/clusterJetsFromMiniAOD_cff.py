...
from RecoBTag.ImpactParameter.pfJetBProbabilityBJetTags_cfi import pfJetBProbabilityBJetTags
...
def setupHeavyIonJets(tag, sequence, process, isMC, radius = -1, JECTag = 'None'):
    ...
    addToSequence( tag+'pfJetBProbabilityBJetTags',
                   pfJetBProbabilityBJetTags.clone(tagInfos = [tag+'pfImpactParameterTagInfos']),
                   process, sequence)
    ...
    addToSequence( tag+'patJets',
                   patJets.clone(
                       ...
                       jetSource = tag+'Jets',
                       discriminatorSources = cms.VInputTag(cms.InputTag(tag+'pfDeepCSVJetTags','probb'), cms.InputTag(tag+'pfDeepCSVJetTags','probc'), cms.InputTag(tag+'pfDeepCSVJetTags','probudsg'), cms.InputTag(tag+'pfDeepCSVJetTags','probbb'), cms.InputTag(tag+'pfJetProbabilityBJetTags'), cms.InputTag(tag+'pfJetBProbabilityBJetTags')),
