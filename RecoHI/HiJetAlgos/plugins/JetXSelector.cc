...
class JetXSelector : public edm::stream::EDProducer<> {
...
public:
  ...
  static void fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
    ...
    desc.add<edm::InputTag>("offPV", edm::InputTag(""))->setComment("InputTag used for retrieving primary vertices in event.");
    desc.add<bool>("dummy", "")->setComment( "God knows what this does");
