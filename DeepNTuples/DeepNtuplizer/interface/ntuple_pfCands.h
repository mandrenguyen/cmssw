...
private:
    ...
    static constexpr size_t max_pfcand_=200;

    float pfcand_pt_[max_pfcand_];
    float pfcand_eta_[max_pfcand_];
    float pfcand_phi_[max_pfcand_];
    float pfcand_mass_[max_pfcand_];
    float pfcand_energy_[max_pfcand_];
    float pfcand_calofraction_[max_pfcand_];
    float pfcand_hcalfraction_[max_pfcand_];
    float pfcand_dxy_[max_pfcand_];
    float pfcand_dxysig_[max_pfcand_];
    float pfcand_dz_[max_pfcand_];
    float pfcand_dzsig_[max_pfcand_];
    float pfcand_pperp_ratio_[max_pfcand_];
    float pfcand_ppara_ratio_[max_pfcand_];
    float pfcand_deta_[max_pfcand_];
    float pfcand_dphi_[max_pfcand_];
    float pfcand_etarel_[max_pfcand_];
    unsigned int pfcand_frompv_[max_pfcand_];
    unsigned int pfcand_id_[max_pfcand_];
    int pfcand_charge_[max_pfcand_];
    unsigned int pfcand_track_qual_[max_pfcand_];
    unsigned int pfcand_track_chi2_[max_pfcand_];
    unsigned int pfcand_npixhits_[max_pfcand_];
    unsigned int pfcand_nstriphits_[max_pfcand_];
    unsigned int pfcand_nlosthits_[max_pfcand_];
    float pfcand_trackjet_d3d_[max_pfcand_];
    float pfcand_trackjet_d3dsig_[max_pfcand_];
    float pfcand_trackjet_dist_[max_pfcand_];
    float pfcand_trackjet_decayL_[max_pfcand_];
    ...
    //float  Cpfcan_dzsig_[max_pfcand_];
