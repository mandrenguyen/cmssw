...
process.source = cms.Source("PoolSource",
                            ...
                            fileNames = cms.untracked.vstring(
                                ...
                                '/store/himc/RunIIpp5Spring18DR/JPsiMM_TuneCUETP8M1_5p02TeV_pythia8/AODSIM/94X_mc2017_realistic_forppRef5TeV-v2/270000/DAC85D32-BB44-E911-B7EC-B02628342EE0.root'
                            )
)
...
process.ak3PFJetAnalyzer.trackSelection = process.ak3PFSecondaryVertexTagInfos.trackSelection
process.ak3PFJetAnalyzer.trackPairV0Filter = process.ak3PFSecondaryVertexTagInfos.vertexCuts.v0Filter

process.ak4PFJetAnalyzer.doLifeTimeTagging = False
process.ak4PFJetAnalyzer.doExtendedFlavorTagging = False
process.ak3PFJetAnalyzer.doLifeTimeTagging = False
process.ak3PFJetAnalyzer.doExtendedFlavorTagging = False
