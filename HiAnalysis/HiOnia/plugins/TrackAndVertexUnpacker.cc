...
using namespace pat;
// TrackAndVertexUnpacker is also provided by
// HeavyIonsAnalysis/TrackAnalysis.  The two implementations are identical;
// use that registration in a combined HiForest/Onia release.
